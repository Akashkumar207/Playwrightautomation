...
test('Table test', async ({ page }) => {
    ...
    console.log("Total number of  headerCountStatic in the table: " + headerCountStatic);

    // Dynamic  Table Header count
    const tableHeaders = await page.locator('thead tr th');
    const headerCountdynamic = await tableHeaders.count();
    console.log("Total number of headerCount in the table: " + headerCountdynamic);
