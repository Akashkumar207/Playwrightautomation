...
test('Keyboard Actions test', async ({ page }) => {
    ...
    const pastelement = await page.locator("textarea[placeholder='Paste another version of the text here.']")
    
    await page.keyboard.press('Control+V');

   await expect(copyelement).toHaveValue("hello my dear friend where are you")
