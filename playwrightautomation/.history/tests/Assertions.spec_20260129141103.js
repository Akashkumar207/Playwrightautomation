...
// await expect(response).toBeOK()	Response has an OK status
    ...
    newsletter.not.toBeChecked()

 const maleRadio=  await expect(page.locator('#gender-male'))
 maleRadio.toBeChecked()
 await expect(maleRadio).not.toBeChecked()

  const  registerbutton= await expect(page.locator('#register-button'))
  registerbutton.toHaveAttribute('type', 'submit')
