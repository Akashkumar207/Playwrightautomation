...
test('Table test', async ({ page }) => {
    ...
    console.log("Total number of  staticheadercount in the table: " + staticheadercount);
    ...
    console.log("Total number of dynamicheadercount in the table: " + dynamicheadercount);
