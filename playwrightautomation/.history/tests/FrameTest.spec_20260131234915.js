...
//    await frame1.locator('input[type="text"]').fill('Hello Frame 1');
  ...
  await page.frameLocator('iframe[src="frame_1.html"]').locator('input[type="text"]').fill('Hello Frame 1');
   // await expect(page.frameLocator('iframe[src="frame_1.html"]').locator('input[type="text"]')).toHaveValue('Hello Frame 1');
