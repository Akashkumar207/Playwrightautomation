...
test('Multiple file upload test', async ({ page, browserName }) => {
  ...
  await expect(page.locator("//li[normalize-space()='JyotiPic.png']")).toHaveText('JyotiPic.png')
  await expect(page.locator("//li[normalize-space()='JyotiPhoto.png']")).toHaveText('JyotiPhoto.png')
