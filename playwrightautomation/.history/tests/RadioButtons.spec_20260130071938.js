...
test('QA Dashboard Login Test', async ({ page }) => {
  ...
  // Fill Email
  await page.locator('input[name="Input.Email"]').fill('testuser@example.com');

  // Fill Password
  await page.locator('input[name="Input.Password"]').fill('Password@123');
  ...
  // Post-login validation (URL or dashboard element)
